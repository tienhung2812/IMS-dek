...
public class ContactController {
	...
	@FXML
	private Button deregister, Add, Remove ;	
    ...
    private void handleButtonAdd(ActionEvent event) throws Exception { // Button them contact
		...
		{
			mainController.ErrorDialog("Insert Username or Password !!!");
		}
		else
		{
			if( kiemtra == true)
			{
				mainController.ErrorDialog("URI is exists !!!");
				ContactURI.clear();
    ...
    private void handleButtonRemove(ActionEvent event) throws Exception { // Xoa contact list contact
		...
		if(selectedItem == null)
			mainController.ErrorDialog("Choice contact need delete !!!");
		else
			tableview.getItems().remove(selectedItem);
	}
	
//	public void changeStageDeregister()
//	  {
...
//	  }
	...
	private void handleButtonDeregister(ActionEvent event) throws Exception { // button xoa dang ki -> ra man hinh register
		...
		//sipListener.deregister(username.getText(), password.getText());
